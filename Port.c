 ...
 * @file        Port
 *
 * @brief       Source file for Port Module APIs on TM4C123GH6PM Microcontroller
 *
 * @version     1.1.2
 *
 * @author      Islam Ehab
...
************************************************************************************/
/**
 * @fn                  void Port_Init(const Port_ConfigType* ConfigPtr)
 *
 * @brief               Function to initialize the port driver Module
 *
...
void Port_SetPinMode(Port_PinType Pin, Port_PinModeType Mode)
{
    ...
    */
    ...
    /* 
     * For loop to loop on array of structure till reaches the given Pin parameter 
     * Note: if the program get out of this loop without modifing Id variable
     * that's mean Pin Parameter is wrong and there is a DET Error will be 
     * reported under this loop
    */
    for(counter = 0; counter < PORT_CONFIGURED_CHANNLES; counter++)
    {
        /* 
         * Check if this structure index of the array pinNum is equal 
         * to the given Pin 
        */ 
        if(Port_Channels[counter].pinNum == Pin)
        {
            ...
            /* Get out of the Loop because the Id Reacehd successfuly */
            break;
        }
        else
        {
...
/* Check if DET Error is enabled or not through configuration tool */
    ...
    /* 
     * Check for incorrect PortPin ID Passed 
     * Note: This variable should be changed in the upper loop 
     * if not, a DET Error will be reported
    */
    ...
    if(Mode > PORT_F_PIN_1_AF14_TRD1)
    {
        /*
