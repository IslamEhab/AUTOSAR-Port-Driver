 ...
 * @file        Port.h
 *
 * @brief       Header file for Port Module on TM4C123GH6PM Microcontroller
 *
 * @version     1.1.2
 *
 * @author      Islam Ehab
 ...
 *
 * @brief   Used to decide the mode of internal pull up
 ...
 *
 * @brief   This enum has all the alternative function values
 *          of the TM4C123GH6PM
 ...
 *
 * @brief   Type definition for Port_PinType used by PORT APIs
 *          Which used to decide which pin number is used
 *
 * @note     You can find these values @Port_PinNumEnum
 */
 ...
 *
 * @brief   Type definition for Port_PinModeType used by PORT APIs
 *          Which used to decide the mode of the Pin
 *
 * @note    You can find these values @ref Port_PinModeEnum
 */
...
/* Define used as the maximum numb of pins Check */
 ...
 *          You can find its value @ref Port_PinNumEnum
 *
 * @var     Port_ConfigChannel::portNum
 *          member 'portNum' used to decide which port are used with the required pin
 *          You can find its vale @ref Port_PortNumEnum
 *
 * @var     Port_ConfigChannel::direction
 *          member 'direction' used to decide if the pin is input or output
 *          You can find its value @ref Port_PinDirectionType
 *
 * @var     Port_ConfigChannel::mode
 *          member 'mode' used to decide which mode is used to decide which mode is used
 *          (GPIO or any alternative function)
 *          You can find its value @ref Port_PinModeEnum
 *          Note: if you want to use Analog function put @ref ANALOG_MODE_SELECTED
 *
 ...
 *          You can find its value @ref Port_InternalResistor
 *
 ...
 *          You can find its value @ref PIN_DIRECTION_CHANGEABILITY
 *
...
typedef struct{
    ...
    Port_PinModeType            mode;                      /** member 'mode' used to decide which mode is used
                                                              (GPIO or any alternative function)
                                                              You can find its value @ref Port_PinModeEnum
                                                              Note: if you want to use Analog function put @ref ANALOG_MODE_SELECTED */

    Port_InternalResistor       resistor;                  /** member 'resistor' used to decide if the internal resistor
                                                              is enabled or not and its mode if enabled
                                                              You can find its value @ref Port_InternalResistor */
 ...
 *        so that, PORT_CONFIGURED_CHANNELS shall equal 39 in TM4C123GH6PM
 *
